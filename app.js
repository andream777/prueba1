...
//valor
 ...
 if (valor_she < 100) {  
    ...
    //valor de la barra de carga

    let var_css = document.documentElement.style;

    let porc_var = ((data.values[0][9] / data.values[1][9])*100)-100;

    var_css.setProperty('--tamano-bar', porc_var + '%')
    ...
    favoritos_new.innerHTML = '';
     ...
     dt_actual.innerText = data.values[1][6];
