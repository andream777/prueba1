...
let url = 'https://sheets.googleapis.com/v4/spreadsheets/11MAgtqWkPDoBiMXjusu2RNUefhHYejvxC69DHSxbmm4/values/probabilidades!A2:E39?key=AIzaSyDnn1QkpAhLOI1U07nm29jYQPKOUxE10Xo';
...
fetch(url)
 ...
 let favoritos = document.querySelectorAll('.fav-1 img')
       ...
       for(var f = 0; f < favoritos.length; f++){
         ...
         favoritos[f].src = `img/${data.values[f][4]}.jpg`;
...
infor_i[0].addEventListener('click', function() {
